...
const Details = ({ darkMode, title, description, img, li, link }) => {

    return (
        <div className=' dark:text-whiteFont text-blackFont px-6 md:flex gap-4 mt-28 '  >
            <div className='h-[50vh]  border p-2 border-black/20 dark:border-white/20 md:w-[40%] lg:w-[40%] relative group'>
